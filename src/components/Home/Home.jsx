...
export default function Home() {
    return (
        <>
            ...
            <img src={group} className={styles.photo} alt="Group of people laughing"/>
            ...
            <img src={girl} className={styles.photo} alt="Girl sitting on a bus in the desert"/>
            ...
            <img src={guy} className={styles.photo} alt="Model in Zion National Park"/>
